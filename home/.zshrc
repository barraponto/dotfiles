...
plugins=(archlinux battery compleat fasd gem git github history-substring-search mercurial node npm pip python rvm screen sprunge urltools vagrant virtualenvwrapper)
